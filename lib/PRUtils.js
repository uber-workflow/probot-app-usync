...
module.exports = class PRUtils {
  ...
  async getPartnerPR_old(PR, includeClosed) {
  ...
  async getPartnerPR(PR, includeClosed) {
    ...
    const partnerPR = await this.getPartnerPR_old(PR, includeClosed);
  ...
  async getPRFromPushPayload(payload) {
    return this._getPR(
      {
  ...
  async getPRFromChecksPayload(payload) {
    return this._getPR(
      {
  ...
  async getPRFromStatusPayload(payload) {
  ...
  async mergePR(PR) {
    ...
    await this.request(`PUT /repos/:repoName/pulls/:number/merge`, {
      number,
      repoName,
      data: {
        commit_message,
  ...
  pushPayloadHasCopyableCommits(pushPayload) {
